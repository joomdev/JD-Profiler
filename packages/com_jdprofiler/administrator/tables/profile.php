 ...
 * @since  1.6
 */
class JdprofilerTableprofile extends JTable
{
	/**
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_jdprofiler.profile.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_jdprofiler/access.xml',
				"/access/section[@name='profile']/"
			);
			$default_actions = JAccess::getAssetRules('com_jdprofiler.profile.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_jdprofiler.profile.' . (int) $this->$k;
	}
