 ...
 * @since  1.6
 */
class JdprofilerTableteam extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_jdprofiler.team.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_jdprofiler/access.xml',
				"/access/section[@name='team']/"
			);
			$default_actions = JAccess::getAssetRules('com_jdprofiler.team.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_jdprofiler.team.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_jdprofiler');
